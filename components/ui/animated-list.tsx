...
const AnimatedList: React.FC<AnimatedListProps> = ({
  ...
  className = 'w-full',
  listClassName = 'max-h-[225px]',
  itemClassName = '',
  itemGapClassName = 'mb-0',
  ...
  return (
    <div className={`relative w-[500px] ${className}`}>
      <div
        ref={listRef}
        className={`${listClassName} overflow-y-auto p-2 ${
          displayScrollbar
      ...
      >
        {items.map((item, index) => (
          ...
          >
            <div className={`p-1 bg-[#111] rounded-lg ${selectedIndex === index ? 'bg-[#222]' : ''} ${itemClassName}`}>
